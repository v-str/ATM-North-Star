#ifndef CONSOLE_EDITOR_DUPLICATE_H
#define CONSOLE_EDITOR_DUPLICATE_H
...
template <typename T>
std::string ConsoleEditorDuplicate::ConvertValueToString(const T& value) {
  std::stringstream stream;
  stream << value;
  return stream.str();
}

#endif  // CONSOLE_EDITOR_DUPLICATE_H
